...
// 素数を生成
let primeList = generatePrimes(2000);
// 10,000以上の素数のみを抽出　この処理いらないのでは？
let goodsizePrimeList = primeList.filter(prime => prime >= 1);
// クイズを生成
...
function gameFinished(score) {
    const tweetText = `#にばいめーかーeasy 10問を${score}秒でクリアしました！\nhttps://green-plus.github.io/nibaimaker/`;
